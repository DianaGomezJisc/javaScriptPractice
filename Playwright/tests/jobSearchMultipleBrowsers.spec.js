 ...
 * You need to create a 'tests' folder as part of the configuration
 * To run a single test go to the folder JS-basico\Playwright\tests  and run: npx playwright test tests/jobSearchMultipleBrowsers.spec.js
 ...
 * For more info go to: https://github.com/microsoft/playwright
 */
